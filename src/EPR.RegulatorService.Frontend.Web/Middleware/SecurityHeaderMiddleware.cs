...
public class SecurityHeaderMiddleware
{
    ...
    public async Task Invoke(HttpContext httpContext, IConfiguration configuration)
    {
        ...
        httpContext.Items[EPR.RegulatorService.Frontend.Web.Constants.ContextKeys.ScriptNonceKey] = scriptNonce;
    ...
    private static string GetContentSecurityPolicyHeader(string scriptNonce, string whitelistedFormActionAddresses)
    {
        ...
        const string baseUrl = "base-uri 'none'";
        const string requiredTrustedTypes = "require-trusted-types-for 'script'";
        ...
        return string.Join(";", defaultSrc, objectSrc, baseUrl, requiredTrustedTypes, frameAncestors, upgradeInsecureRequests,
