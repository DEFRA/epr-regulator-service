namespace EPR.RegulatorService.Frontend.Web.Mappings.ManageRegistrationSubmissions
{
    ...
    {
        public static RegistrationSubmissionsViewModel MapToViewModel(RegistrationSubmissionsDto dto)
        {
        ...
        public static RegistrationSubmissionsDto MapToDto(RegistrationSubmissionsViewModel viewModel)
        {
            return new RegistrationSubmissionsDto
            {
