namespace EPR.RegulatorService.Frontend.Web.Mappings.ManageRegistrationSubmissions
{
    ...
    public class RegistrationSubmissionDetailsModelMapper
    {
        public static RegistrationSubmissionDetailsViewModel MapToViewModel(RegistrationSubmissionDetailsDto dto)
        {
