    ...
    public partial class RegistrationSubmissionsController
    {
        ...
        private static void UpdateRegistrationSubmissionDetailsViewModel(RegistrationSubmissionDetailsViewModel existingModel, RegulatorDecisionRequest regulatorDecisionRequest)
        {
            ...
            else
            {
                ...
                existingModel.SubmissionDetails.StatusPendingDate = regulatorDecisionRequest.Status == RegistrationSubmissionStatus.Cancelled.ToString() ? regulatorDecisionRequest.DecisionDate : null;
                existingModel.SubmissionDetails.RegistrationDate = regulatorDecisionRequest.Status == RegistrationSubmissionStatus.Granted.ToString() ? DateTime.UtcNow : null;
                existingModel.RegistrationDateTime = regulatorDecisionRequest.Status == RegistrationSubmissionStatus.Granted.ToString() ? DateTime.UtcNow : null;
            }
        }
