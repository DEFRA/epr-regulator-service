namespace EPR.RegulatorService.Frontend.Web.TagHelpers.ManageRegistrationSubmissions
{
    ...
    [HtmlTargetElement("submission-reference-number-panel", TagStructure = TagStructure.NormalOrSelfClosing)]
    public class SubmissionReferenceNumberPanelTagHelper : TagHelper
    {
