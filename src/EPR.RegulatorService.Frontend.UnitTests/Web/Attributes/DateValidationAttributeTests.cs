...
public class DateValidationAttributeTests
{
    ...
    {
        // Arrange
        var viewModel = new CancelDateRegistrationSubmissionViewModel { SubmissionId = _submissionId, Day = day, Month = month, Year = year };
    ...
    {
        // Arrange
        var viewModel = new CancelDateRegistrationSubmissionViewModel { SubmissionId = _submissionId, Day = 1, };
